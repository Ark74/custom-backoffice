...
Easily lets you customize the dashboard and login screen of your WordPress site.
...
== Changelog ==
For more information, see [Releases](http://copier-coller.com/custom-backoffice/).

= 1.0 =
* Initial release.

== Upgrade Notice ==
To have information on new release, follow http://copier-coller.com

== Frequently Asked Questions ==
Do you have questions or issues with Custom Backoffice? Use these support channels appropriately.
1. [Docs](http://copier-coller.com/custom-backoffice)
1. [Support Forum](http://wordpress.org/support/plugin/custom-backoffice)

== Screenshots ==
1. Options settings
2. default dashboard
3. dashboard with all options activated
4. login screen